...
const Calculator = {
    ...
    First_Operand: null,
    // This checks whether or not the second operand has been inputed by user.
...
function Handle_Operator(Next_Operator){
    ...
    if (First_Operand == null) {
        ...
        // If an operator exists, property lookup is performed for the operator in the Perform_Calculation object and the function that matches the operator is executed.
        let result = Perform_Calculation[operator](Value_Now
            , Value_of_Input);
...
keys.addEventListener('click', (event) => {
    ...
    // Ensure that AC clears all inputs from the Calculator.
